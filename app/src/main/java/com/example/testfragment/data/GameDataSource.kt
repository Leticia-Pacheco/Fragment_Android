    ...
    companion object{
        fun getGames(context: Context) : ArrayList<Game> {
            ...
            games.add(Game(1,
                           ...
                           4.5f, // quando o tipo do dado for float, colocamos um f na frente
                           listOf(
                                    Console(1, "Playstation 1", "Sony", "1996-12-01"),
                                    Console(2, "Xbox 360", "Sony", "1996-12-05")
                           )))
            ...
            games.add(Game(2,
                           ...
                           5f, // quando o tipo do dado for float, colocamos um f na frente
                           listOf(
            ...
            games.add(Game(3,
                           ...
                           4f, // quando o tipo do dado for float, colocamos um f na frente
                           listOf(
            ...
            games.add(Game(4,
                           ...
                           3f,  // quando o tipo do dado for float, colocamos um f na frente
                           listOf(
